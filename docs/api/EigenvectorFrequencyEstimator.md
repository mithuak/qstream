...
| Python import | `from qstream import EigenvectorFrequencyEstimator` |

## Signature

```python
EigenvectorFrequencyEstimator(window=64, order=4, nfft=128, update_every=16)
```

## What it computes

Pseudospectrum from the minimum-eigenvalue eigenvector `v` of the autocorrelation matrix:
