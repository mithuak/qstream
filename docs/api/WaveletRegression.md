...
| Python import | `from qstream import WaveletRegression` |

## Signature

```python
WaveletRegression(window=64, levels=3, update_every=16)
```

## What it computes

Denoises a signal via level-dependent wavelet shrinkage and reconstructs the regression (smoothed) estimate.
