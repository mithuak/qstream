...
| Python import | `from qstream import ReassignedSpectrogram` |

## Signature

```python
ReassignedSpectrogram(window=64, nfft=64, update_every=16)
```

## What it computes

Moves spectrogram energy to the local center of gravity, sharpening the time-frequency representation.
